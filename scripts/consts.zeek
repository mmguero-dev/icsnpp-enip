##! consts.zeek
##!
##! Binpac Ethernet/IP (ENIP) Analyzer - Defines ENIP and CIP Constants for main.zeek
##!
...
export {
    ...
    ###############################################################################################
    const enip_commands: table[count] of string = {
        [0x00] = "NOP",
        [0x04] = "List Services",
        [0x63] = "List Identity",
    ...
    ###############################################################################################
    const enip_statuses: table[count] of string = {
        [0x00] = "Success",
        [0x01] = "Invalid/Unsupported Command",
        [0x02] = "Insufficient Memory Resources",
        [0x03] = "Malformed or Incorrect Data",
        [0x64] = "Invalid Session Handle",
        [0x65] = "Invalid Length",
        [0x69] = "Unsupported Protocol Version",
        [0x6A] = "CIP Service Not Allowed",
    } &default = function(n: count): string {return fmt("Unknown ENIP Status-0x%02x", n); };

    ###############################################################################################
    #####################################  CIP Status Codes  ######################################
    ###############################################################################################
    const cip_statuses: table[count] of string = {
        [0x00] = "Success",
        ...
        [0xFF] = "Still Processing",
    } &default = function(n: count): string {return fmt("Unknown CIP Status-0x%02x", n); };

    ###############################################################################################
    #################################  CIP Extended Status Codes  #################################
    ###############################################################################################
    const cip_extended_status: table[count] of string = {
        [0x100] = "Connection in use or duplicate Forward Open",
        [0x103] = "Transport class and trigger combination not supported",
        [0x106] = "Ownership conflict",
        [0x107] = "Target connection not found",
        [0x108] = "Invalid network connection parameter",
        [0x109] = "Invalid connection size",
        [0x110] = "Target for connection not configured",
        [0x111] = "RPI not supported",
        [0x112] = "RPI value(s) not acceptable",
        [0x113] = "Out of connections",
        [0x114] = "Vendor ID or product code mismatch",
        [0x115] = "Device type mismatch",
        [0x116] = "Revision mismatch",
        [0x117] = "Invalid produced or consumed application path",
        [0x118] = "Invalid or inconsistent configuration application path",
        [0x119] = "Non-listen only connection not opened",
        [0x11A] = "Target object out of connections",
        [0x11B] = "RPI is smaller than the production inhibit time",
        [0x11C] = "Transport class not supported",
        [0x11D] = "Production trigger not supported",
        [0x11E] = "Direction not supported",
        [0x11F] = "Invalid O->T Fixed/Variable",
        [0x120] = "Invalid T->O Fixed/Variable",
        [0x121] = "Invalid O->T Priority",
        [0x122] = "Invalid T->O Priority",
        [0x123] = "Invalid O->T connection type",
        [0x124] = "Invalid T->O connection type",
        [0x125] = "Invalid O->T redundant owner",
        [0x126] = "Invalid configuration size",
        [0x127] = "Invalid O->T size",
        [0x128] = "Invalid T->O size",
        [0x129] = "Invalid configuration application path",
        [0x12A] = "Invalid consuming application path",
        [0x12B] = "Invalid producing application path",
        [0x12C] = "Configuration symbol does not exist",
        [0x12D] = "Consuming symbol does not exist",
        [0x12E] = "Producing symbol does not exist",
        [0x12F] = "Inconsistent application path combination",
        [0x130] = "Inconsistent consume data format",
        [0x131] = "Inconsistent produce data format",
        [0x132] = "NULL ForwardOpen not supported",
        [0x203] = "Connection timed out",
        [0x204] = "Unconnected request timed out",
        [0x205] = "Parameter error in unconnected request",
        [0x206] = "Message too large for UnconnectedSend",
        [0x207] = "Unconnected acknowledged without reply",
        [0x301] = "No buffer memory available",
        [0x302] = "Network bandwidth not available for data",
        [0x303] = "No consumed connection ID filter available",
        [0x304] = "Not configured to send scheduled priority data",
        [0x305] = "Schedule signature mismatch",
        [0x306] = "Schedule signature validation not possible",
        [0x311] = "Port not available",
        [0x312] = "Link address not valid",
        [0x315] = "Invalid segment in connection path",
        [0x316] = "ForwardClose connection path mismatch",
        [0x317] = "Scheduling not specified",
        [0x318] = "Link address to self invalid",
        [0x319] = "Secondary resources unavailable",
        [0x31A] = "Rack connection already established",
        [0x31B] = "Module connection already established",
        [0x31C] = "Miscellaneous",
        [0x31D] = "Redundant connection mismatch",
        [0x31E] = "No more user configurable link consumer resources available in the producing module",
        [0x31F] = "No more user configurable link consumer resources configured in the producing module",
        [0x800] = "Network link offline",
        [0x801] = "Incompatible Multicast RPI",
        [0x802] = "Invalid Safety Connection Size",
        [0x803] = "Invalid Safety Connection Format",
        [0x804] = "Invalid Time Correction Connection Parameters",
        [0x805] = "Invalid Ping Interval EPI Multiplier",
        [0x806] = "Time Coordination Msg Min Multiplier",
        [0x807] = "Network Time Expectation Multiplier",
        [0x808] = "Timeout Multiplier",
        [0x809] = "Invalid Max Consumer Number",
        [0x80A] = "Invalid CPCRC",
        [0x80B] = "Time Correction Connection ID Invalid",
        [0x80C] = "SCID Mismatch",
        [0x80D] = "TUNID not set",
        [0x80E] = "TUNID Mismatch",
        [0x80F] = "Configuration operation not allowed",
        [0x810] = "No target application data available",
        [0x811] = "No originator application data available",
        [0x812] = "Node address has changed since the network was scheduled",
        [0x813] = "Not configured for off-subnet multicast",
        [0x814] = "Invalid produce/consume data format",
    } &default = function(n: count): string {return fmt("Unknown Extended Status-0x%04x", n); };

    ###############################################################################################
    #####################################  CIP Service Codes  #####################################
    ###############################################################################################
    const cip_services: table[count] of string = {
    ...
    #######################################  CIP Class IDs  #######################################
    ###############################################################################################
    const cip_classes: table[count] of string = {
        [0x00] = "",
        [0x01] = "Identity",
        [0x02] = "Message Router",
        [0x03] = "DeviceNet",
    ...
    #####################################  CIP Vendor Codes  ######################################
    ###############################################################################################
    const cip_vendors: table[count] of string = {
        [0] = "Reserved",
        ...
        [402] = "BUSWARE Direct",
        [403] = "Eaton Electric B.V. (formerly Holec Holland N.V.)",
        ...
        [724] = "Industrial Network Controls, LC",
    ...
    } &default = function(n: count): string {return fmt("Unknown Vendor-0x%02x", n); };

    ###############################################################################################
    ####################################  CIP Device Profiles  ####################################
    ###############################################################################################
    const cip_device_types: table[count] of string = {
        ...
        [45] = "CIP Motion Safety Drive Device",
        [46] = "Safety Drive Device",
        [47] = "CIP Motion Encoder",
    ...
    } &default = function(n: count): string {return fmt("Unknown Device-0x%02x", n); };
